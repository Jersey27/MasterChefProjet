...
CREATE TABLE Composition (id_composition INT IDENTITY NOT NULL,
quantite_ingredient_recette BIGINT,
id_ingredient INT,
id_recette INT,
PRIMARY KEY (id_composition));

ALTER TABLE Composition ADD CONSTRAINT FK_Composition_id_ingredient FOREIGN KEY (id_ingredient) REFERENCES Ingredients (id_ingredient);

ALTER TABLE Composition ADD CONSTRAINT FK_Composition_id_recette FOREIGN KEY (id_recette) REFERENCES Recettes (id_recette);
