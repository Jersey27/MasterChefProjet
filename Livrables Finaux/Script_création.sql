...
type_ingredient VARCHAR(20) NOT NULL CHECK (type_ingredient IN('Frais','Surgel�', 'Longue conserv')),
...
type_materiel VARCHAR(30) NOT NULL CHECK (type_materiel IN('Mat�riel commun','Mat�riel de restauration', 'Mat�riel de cuisine')),
...
type_recette VARCHAR(10) NOT NULL CHECK (type_recette IN('Entr�e','Plat', 'Dessert')),
